...
import { PARTS, PART_CATEGORIES, MARKUP_PERCENT } from '../data/parts';
    ...
    <div className="min-h-screen bg-[#080808] text-white font-sans">
      ...
      <section className="px-8 pt-32 pb-12">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#FF6B00] text-xs font-bold uppercase tracking-[0.3em] mb-3">Sourced & Stocked</p>
          <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tighter mb-4">Parts Catalog</h1>
          <p className="text-zinc-500 text-sm max-w-xl leading-relaxed">
            Genuine and take-off Arrma parts for the Big Rock / Granite / Senton / Typhon / Vorteks family — sourced in bulk, priced to ship.
