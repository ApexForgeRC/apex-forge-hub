    ...
    <div className="min-h-screen bg-[#080808] text-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 bg-[#080808]/80 backdrop-blur-md border-b border-white/5">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="mailto:paul@apexforgerc.com" className="group flex items-center gap-2 bg-[#E10600] text-black font-black px-5 py-2.5 rounded-full text-xs uppercase tracking-wider hover:bg-[#E10600]/90 transition-all">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="max-w-6xl">
            <div className="flex items-center gap-3 mb-7">
              ...
              <span className="text-[#E10600] text-xs font-bold uppercase tracking-[0.3em]">
            ...
            <h1 className="text-[clamp(3.6rem,10vw,8.5rem)] font-black leading-[0.88] tracking-tighter uppercase">
              Repair<span className="text-[#E10600]">.</span><br />
              Rebuild<span className="text-[#E10600]">.</span><br />
              Reforge<span className="text-[#E10600]">.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <a
                ...
                className="group flex items-center gap-3 bg-[#E10600] text-black font-black px-8 py-4 rounded-full text-sm uppercase tracking-wider hover:bg-white transition-all duration-300 shadow-[0_0_40px_rgba(225,6,0,0.25)]"
              >
                Get a Repair Quote
      ...
      <section id="services" className="px-8 py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              <p className="text-[#E10600] text-xs font-bold uppercase tracking-[0.3em] mb-3">What Apex Forge Does</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-7 bg-[#141414] border border-white/5 rounded-3xl p-10 flex flex-col justify-between min-h-[330px] hover:border-[#E10600]/30 transition-all duration-300 group">
              <div>
                ...
                <p className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em] mb-3">01 // Repair</p>
              ...
              <div className="flex items-center justify-between pt-6 border-t border-white/5">
                ...
                <ArrowUpRight className="text-zinc-700 group-hover:text-[#E10600] transition-colors" size={20} />
              </div>
            </div>
            ...
            <div className="md:col-span-5 bg-[#141414] border border-white/5 rounded-3xl p-10 flex flex-col justify-between min-h-[330px] hover:border-[#E10600]/30 transition-all duration-300 group">
              <div>
                ...
                <p className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em] mb-3">02 // Rebuild</p>
            ...
            <div id="reforged" className="md:col-span-5 bg-[#E10600] rounded-3xl p-10 flex flex-col justify-between min-h-[290px] text-black group">
              <div>
            ...
            <div className="md:col-span-7 bg-[#141414] border border-white/5 rounded-3xl p-10 flex flex-col justify-between min-h-[290px] hover:border-[#E10600]/30 transition-all duration-300 group">
              <div>
                ...
                <p className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em] mb-3">04 // Fabricate</p>
      ...
      <section id="reforged-showcase" className="px-8 py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
            <div>
              <p className="text-[#E10600] text-xs font-bold uppercase tracking-[0.3em] mb-3">Apex Reforged</p>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            <article className="bg-[#141414] border border-white/5 rounded-3xl overflow-hidden hover:border-[#E10600]/30 transition-colors">
              <div className="aspect-[16/9] bg-[linear-gradient(135deg,#151515,#090909)] border-b border-white/5 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative text-center">
                  <Car className="w-12 h-12 text-[#E10600] mx-auto mb-3" />
                  <span className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.3em]">Build Photography Placeholder</span>
                </div>
              </div>
              <div className="p-8">
                <div className="flex items-center justify-between gap-4 mb-4">
                  <span className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em]">AF-RF-001 // Showcase Build</span>
            ...
            <article className="bg-[#141414] border border-white/5 rounded-3xl overflow-hidden hover:border-[#E10600]/30 transition-colors">
              <div className="aspect-[16/9] bg-[linear-gradient(135deg,#151515,#090909)] border-b border-white/5 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-[linear-gradient(rgba(225,6,0,0.035)_1px,transparent_1px),linear-gradient(90deg,rgba(225,6,0,0.035)_1px,transparent_1px)] bg-[size:36px_36px]" />
                <div className="relative text-center">
                  <Wrench className="w-12 h-12 text-[#E10600] mx-auto mb-3" />
                  <span className="text-zinc-600 text-[10px] font-black uppercase tracking-[0.3em]">Project Photography Placeholder</span>
                </div>
              </div>
              <div className="p-8">
                <div className="flex items-center justify-between gap-4 mb-4">
                  <span className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em]">AF-RF-002 // In Development</span>
                  <span className="text-[10px] font-black uppercase tracking-widest border border-[#E10600]/30 bg-[#E10600]/10 text-[#E10600] rounded-full px-3 py-1">Project</span>
                </div>
      ...
      <section id="shop" className="px-8 py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          <p className="text-[#E10600] text-xs font-bold uppercase tracking-[0.3em] mb-3">Parts + Printed Goods</p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link to="/parts" className="group bg-[#141414] border border-white/5 rounded-3xl p-10 min-h-[280px] flex flex-col justify-between hover:border-[#E10600]/30 transition-all">
              <div>
                ...
                <p className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.25em] mb-3">Parts Catalog</p>
            ...
            <a href="https://apexforgemotorsports.etsy.com" target="_blank" rel="noopener noreferrer" className="group bg-[#E10600] rounded-3xl p-10 min-h-[280px] flex flex-col justify-between text-black">
              <div>
                <div className="w-12 h-12 rounded-2xl bg-black/10 flex items-center justify-center mb-6">
